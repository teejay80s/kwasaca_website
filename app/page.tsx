    ...
    <>
      ...
      <section className="relative min-h-screen flex flex-col overflow-hidden" style={{ background: "#0d3320" }}>
        ...
        <div className="relative z-10 bg-black/25 backdrop-blur-[12px] border-t border-white/[0.05]">
          {/* Mobile: single-column icon cards */}
          <div className="sm:hidden flex flex-col gap-2 p-3">
            <div className="stat-card-mobile">
              <div className="stat-icon-mobile"><Shield size={20} /></div>
              <div>
                <div className="stat-number-mobile"><span className="count" data-target="1.0">0</span>%</div>
                <div className="stat-label-mobile">{tr.hero.stat1Label as string}</div>
                <span className="stat-badge-mobile">{tr.hero.stat1Badge as string}</span>
              </div>
            </div>
            <div className="stat-card-mobile">
              <div className="stat-icon-mobile"><MapPin size={20} /></div>
              <div>
                <div className="stat-number-mobile"><span className="count" data-target="16">0</span></div>
                <div className="stat-label-mobile">{tr.hero.stat2Label as string}</div>
              </div>
            </div>
            <div className="stat-card-mobile">
              <div className="stat-icon-mobile"><Users size={20} /></div>
              <div>
                <div className="stat-number-mobile"><span className="count" data-target="500">0</span>K+</div>
                <div className="stat-label-mobile">{tr.hero.stat3Label as string}</div>
              </div>
            </div>
            <div className="stat-card-mobile">
              <div className="stat-icon-mobile"><Globe size={20} /></div>
              <div>
                <div className="stat-number-mobile"><span className="count" data-target="12">0</span></div>
                <div className="stat-label-mobile">{tr.hero.stat4Label as string}</div>
              </div>
            </div>
          </div>
          {/* Desktop: grid */}
          <div className="max-sm:hidden grid grid-cols-4 max-w-7xl mx-auto">
            <div className="py-7 px-9 text-center relative after:content-[''] after:absolute after:right-0 after:top-[20%] after:h-[60%] after:w-px after:bg-white/[0.06]">
              <div className="font-serif text-[42px] font-bold text-white leading-none mb-1.5"><span className="count" data-target="1.0">0</span><span className="text-[#b8860b] text-[26px]">%</span></div>
            ...
            <div className="py-7 px-9 text-center relative after:content-[''] after:absolute after:right-0 after:top-[20%] after:h-[60%] after:w-px after:bg-white/[0.06]">
              <div className="font-serif text-[42px] font-bold text-white leading-none mb-1.5"><span className="count" data-target="16">0</span></div>
              <div className="text-[11.5px] text-white/45 tracking-[0.03em]">{tr.hero.stat2Label as string}</div>
            </div>
            <div className="py-7 px-9 text-center relative after:content-[''] after:absolute after:right-0 after:top-[20%] after:h-[60%] after:w-px after:bg-white/[0.06]">
              <div className="font-serif text-[42px] font-bold text-white leading-none mb-1.5"><span className="count" data-target="48">0</span><span className="text-[#b8860b] text-[26px]">K+</span></div>
              <div className="text-[11.5px] text-white/45 tracking-[0.03em]">{tr.hero.stat3Label as string}</div>
            </div>
            <div className="py-7 px-9 text-center">
              <div className="font-serif text-[42px] font-bold text-white leading-none mb-1.5"><span className="count" data-target="12">0</span></div>
      ...
      {/* ── ABOUT SNAPSHOT ── */}
      <section className="py-32 px-12 bg-white max-sm:bg-transparent max-sm:py-8">

        {/* ── Mobile version (matches prototype) ── */}
        <div className="sm:hidden">
          <div className="section-label-mobile reveal">{tr.about.pill as string}</div>
          <div className="section-title-mobile reveal">
            {tr.about.heading1 as string}<br />{tr.about.heading2 as string}
          </div>
          <div className="section-sub-mobile reveal">
            {tr.about.desc as string}
          </div>
          <div className="about-grid-mobile">
            <div className="about-card-mobile reveal">
              <div className="about-icon-mobile"><Users size={20} /></div>
              <div>
                <h3>{tr.about.feature1Title as string}</h3>
                <p>{tr.about.feature1Sub as string}</p>
              </div>
            </div>
            <div className="about-card-mobile reveal">
              <div className="about-icon-mobile"><Shield size={20} /></div>
              <div>
                <h3>{tr.about.feature2Title as string}</h3>
                <p>{tr.about.feature2Sub as string}</p>
              </div>
            </div>
            <div className="about-card-mobile reveal">
              <div className="about-icon-mobile"><Globe size={20} /></div>
              <div>
                <h3>{tr.about.feature3Title as string}</h3>
                <p>{tr.about.feature3Sub as string}</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-[1280px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
            <div className="relative">
              ...
              <div className="absolute -top-4 -left-8 bg-green-deep text-white rounded-xl px-5 py-4 shadow-xl">
                <div className="font-serif text-[32px] font-bold text-green-400 leading-none mb-1">2003</div>
              ...
              <div className="absolute -bottom-6 -right-7 bg-white border border-gray-200 rounded-2xl px-6 py-5 shadow-xl min-w-[180px]">
                <div className="font-serif text-[40px] font-bold text-green-DEFAULT leading-none mb-1">1%</div>
                <div className="text-xs text-gray-400 mb-2">{tr.about.prevalenceLabel as string}</div>
                <span className="inline-flex items-center gap-1 bg-green-light text-green-mid text-[10px] font-semibold px-2 py-0.5 rounded">{tr.about.prevalenceBadge as string}</span>
              </div>
            </div>
            <div>
              ...
              <p className="text-[15.5px] text-gray-500 leading-[1.8] mb-9 font-light">{tr.about.desc as string}</p>
              <div className="space-y-3 mb-10">
                {[
                  ...
                  <div key={i} className="flex items-start gap-3.5 p-4 rounded-xl bg-gray-50 border border-gray-100 hover:bg-green-pale hover:border-green-light transition-all">
              ...
              <Link href="/about" className="link-arrow">{tr.about.link as string} <ArrowRight size={16} /></Link>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* ── PROGRAMS ── */}
      <section className="relative overflow-hidden bg-cream max-sm:bg-transparent">

        {/* Decorative elements (hidden on mobile) */}
        <div className="absolute top-0 left-0 right-0 h-1 opacity-10 max-sm:hidden" style={{ background: "linear-gradient(90deg,transparent,#dc2626,#14532d,#dc2626,transparent)" }} />
        <div className="absolute top-[-200px] right-[-100px] w-[500px] h-[500px] rounded-full pointer-events-none max-sm:hidden" style={{ background: "radial-gradient(circle,rgba(220,38,38,0.04),transparent 70%)" }} />
        <div className="absolute bottom-[-120px] left-[-80px] w-[300px] h-[300px] rounded-full pointer-events-none opacity-[0.03] max-sm:hidden" style={{ background: "radial-gradient(circle,#14532d,transparent 70%)" }} />

        <div className="max-w-7xl mx-auto px-12 max-lg:px-8 max-sm:px-5 py-[120px] max-lg:py-20 max-sm:py-12">

          {/* ── Mobile version ── */}
          <div className="sm:hidden">
            <div className="section-label-mobile reveal">{tr.programs.pill as string}</div>
            <div className="section-title-mobile reveal">{tr.programs.heading as string}</div>
            <div className="section-sub-mobile reveal">{tr.programs.desc as string}</div>
            <div className="programs-grid-mobile">
              {programs.map((p, idx) => (
                <div key={p.num} className="program-card-mobile reveal" style={{ animationDelay: `${idx * 0.1}s` }}>
                  <div className="program-num-mobile">{p.num}</div>
                  <div className="program-info-mobile">
                    <h3>{p.title}</h3>
                    <p>{p.desc}</p>
                  </div>
                  <div className="program-arrow-mobile">→</div>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="max-sm:hidden">
            ...
            <div className="grid grid-cols-2 max-md:grid-cols-1 max-md:w-full gap-6 max-lg:gap-[18px]">
              <div className="col-span-2 max-md:col-span-1 grid grid-cols-2 max-lg:grid-cols-1 gap-8 bg-white border border-gray-200 rounded-xl overflow-hidden transition-all duration-[0.4s] hover:shadow-[0_24px_64px_rgba(0,0,0,0.05)] hover:-translate-y-1 hover:border-[rgba(220,38,38,0.08)] reveal">
                <div className="relative overflow-hidden min-h-[280px] max-lg:min-h-[200px]">
                ...
                <div className="py-10 pr-10 max-lg:p-7 flex flex-col justify-center">
              ...
              {programs.slice(1).map(({ num, icon: Icon, title, desc }, idx) => (
                <div key={num} className={`bg-white border border-gray-200 rounded-xl p-8 pr-7 pb-7 transition-all duration-[0.4s] relative overflow-hidden hover:-translate-y-2 hover:shadow-[0_20px_48px_rgba(0,0,0,0.05)] hover:border-[rgba(220,38,38,0.08)] reveal ${idx === 0 ? "" : idx === 1 ? "delay-1" : idx === 2 ? "" : idx === 3 ? "delay-1" : idx === 4 ? "" : ""}`}>
      ...
      <section className="py-32 px-12 bg-white max-sm:bg-transparent max-sm:py-8">
        <div className="max-w-[1280px] mx-auto">
          ...
          {/* ── Mobile version ── */}
          <div className="sm:hidden">
            <div className="section-label-mobile reveal">{tr.news.pill as string}</div>
            <div className="section-title-mobile reveal">{tr.news.heading as string}</div>
            <div className="news-featured-mobile reveal">
              <div className="news-featured-img-mobile">
                <span className="tag">{tr.news.featured as string}</span>
                <span className="text-[10px] font-medium" style={{ color: 'rgba(255,255,255,0.6)' }}>
                  {news[0]?.publishedAt ? formatDate(news[0].publishedAt) : "18 Mar 2025"} · {news[0]?.category || "Press Release"}
                </span>
              </div>
              <h3>{news[0]?.title || "KWASACA Launches New Mobile HIV Testing Drive Across Ilorin Metropolis"}</h3>
              <p>{news[0]?.excerpt || "The agency has deployed mobile testing units to communities across Ilorin as part of the quarterly outreach initiative in partnership with SFH Nigeria and the Global Fund."}</p>
              <Link href={`/news/${news[0]?.slug?.current || "#"}`} className="read-more">
                {tr.news.readMore as string} →
              </Link>
            </div>
            <div className="news-list-mobile">
              {(news.length > 1 ? news.slice(1, 3) : [
                { title: "World AIDS Day 2025 Planning Meeting Convenes in Ilorin", category: "Event", publishedAt: "2025-03-10" },
                { title: "2024 Annual HIV Situation Report Published — Download Now", category: "Report", publishedAt: "2025-02-28" },
              ]).map((n: any, i: number) => (
                <Link key={i} href={`/news/${n?.slug?.current || "#"}`} className="news-item-mobile reveal">
                  <div className="news-item-icon-mobile">
                    {n.category === "Event" ? <Calendar size={18} /> : <FileText size={18} />}
                  </div>
                  <div>
                    <div className="news-date">{n.publishedAt ? formatDate(n.publishedAt) : ""}</div>
                    <h4>{n.title}</h4>
                    <span className="tag-sm">{n.category || "News"}</span>
                  </div>
                </Link>
              ))}
            </div>
          ...
          <div className="max-sm:hidden">
            <div className="flex justify-between items-end mb-14 gap-8">
              <div>
                <span className="section-pill mb-4 inline-flex">{tr.news.pill as string}</span>
                <h2 className="section-heading">{tr.news.heading as string}<em className="italic text-green-DEFAULT">{tr.news.headingEm as string}</em></h2>
              </div>
              <Link href="/news" className="link-arrow flex-shrink-0">{tr.news.all as string} <ArrowRight size={16} /></Link>
            </div>

            {news.length > 0 ? (
              <div className="grid grid-cols-1 lg:grid-cols-[1.8fr_1fr] gap-6">
                <Link href={`/news/${news[0]?.slug?.current || "#"}`} className="card group flex flex-col">
                  <div className="h-[280px] relative overflow-hidden flex-shrink-0" style={{ background: "#0d3320" }}>
                    ...
                    <div className="absolute inset-0" style={{ background: "linear-gradient(to bottom,transparent 40%,rgba(13,51,32,0.7))" }} />
                    <span className="absolute top-5 left-5 text-[10px] font-bold uppercase tracking-widest px-3 py-1.5 rounded bg-red-warm text-white">{tr.news.featured as string}</span>
                  </div>
                  <div className="p-9 flex flex-col flex-1">
                    <p className="text-[11.5px] text-gray-400 font-medium mb-3 uppercase tracking-wider">{news[0]?.publishedAt ? formatDate(news[0].publishedAt) : ""} · {news[0]?.category || "News"}</p>
                    <h2 className="font-serif text-2xl font-semibold text-ink leading-[1.3] mb-3 tracking-tight group-hover:text-green-DEFAULT transition-colors">{news[0]?.title || "KWASACA Launches New Mobile HIV Testing Drive Across Ilorin Metropolis"}</h2>
                    <p className="text-sm text-gray-500 leading-[1.7] flex-1 font-light">{news[0]?.excerpt || "The agency has deployed mobile testing units to communities across Ilorin as part of the quarterly outreach initiative in partnership with SFH Nigeria and the Global Fund."}</p>
                    <div className="flex items-center justify-between mt-6 pt-5 border-t border-gray-100">
                      <div className="flex items-center gap-2.5">
                        <div className="w-8 h-8 rounded-full bg-green-light flex items-center justify-center text-xs font-bold text-green-mid">KW</div>
                        <span className="text-sm font-medium text-ink">{tr.news.author as string}</span>
                      </div>
                      <span className="text-sm font-semibold text-green-DEFAULT flex items-center gap-1.5">{tr.news.readMore as string} <ArrowRight size={14} /></span>
                    </div>
                  </div>
                </Link>
                <div className="flex flex-col gap-6">
                  {(news.slice(1, 3).length > 0 ? news.slice(1, 3) : [
                    { title: "World AIDS Day 2025 Planning Meeting Convenes in Ilorin", category: "Event", publishedAt: "2025-03-10", slug: { current: "#" } },
                    { title: "2024 Annual HIV Situation Report Published — Download Now", category: "Report", publishedAt: "2025-02-28", slug: { current: "#" } },
                  ]).map((n: any, i: number) => (
                    <Link key={i} href={`/news/${n?.slug?.current || "#"}`} className="card group flex flex-col flex-1">
                      <div className="h-[120px] relative overflow-hidden flex-shrink-0 bg-green-pale">
                        <div className="absolute inset-0" style={{ backgroundImage: "repeating-linear-gradient(-45deg,transparent 0px,transparent 12px,rgba(20,83,45,0.05) 12px,rgba(20,83,45,0.05) 13px)" }} />
                        <span className={`absolute top-2.5 left-3 text-[9.5px] font-bold uppercase tracking-wider px-2 py-0.5 rounded text-white ${n.category === "Event" ? "bg-red-warm" : n.category === "Report" ? "bg-green-DEFAULT" : "bg-green-glow"}`}>{n.category || "News"}</span>
                      </div>
                      <div className="p-5 flex-1">
                        <p className="text-[11px] text-gray-400 font-medium mb-2 uppercase tracking-wide">{n.publishedAt ? formatDate(n.publishedAt) : ""}</p>
                        <h3 className="font-serif text-[17px] font-semibold text-ink leading-[1.35] group-hover:text-green-DEFAULT transition-colors">{n.title}</h3>
                      </div>
                    </Link>
                  ))}
                </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-[1.8fr_1fr] gap-6">
                <div className="card flex flex-col">
                  <div className="h-[280px] relative overflow-hidden flex-shrink-0" style={{ background: "#0d3320" }}>
                    <div className="absolute inset-0 opacity-[0.03]" style={{ backgroundImage: "linear-gradient(white 1px,transparent 1px),linear-gradient(90deg,white 1px,transparent 1px)", backgroundSize: "40px 40px" }} />
                    <span className="absolute top-5 left-5 text-[10px] font-bold uppercase tracking-widest px-3 py-1.5 rounded bg-red-warm text-white">Featured</span>
                  </div>
                  <div className="p-9">
                    <p className="text-[11.5px] text-gray-400 uppercase tracking-wider mb-3">March 18, 2025 · Press Release</p>
                    <h2 className="font-serif text-2xl font-semibold text-ink leading-[1.3] mb-3">KWASACA Launches New Mobile HIV Testing Drive Across Ilorin Metropolis</h2>
                    <p className="text-sm text-gray-500 leading-[1.7] font-light">The agency has deployed mobile testing units to 12 communities across Ilorin East, West and South LGAs as part of the quarterly outreach initiative.</p>
                  </div>
                </div>
                <div className="flex flex-col gap-6">
                  {[{ cat: "Event", title: "World AIDS Day 2025 Planning Meeting Convenes in Ilorin", date: "March 10, 2025" },
                    { cat: "Report", title: "2024 Annual HIV Situation Report Published — Download Now", date: "Feb 28, 2025" },
                  ].map((n, i) => (
                    <div key={i} className="card flex flex-col flex-1">
                      <div className="h-[120px] relative bg-green-pale flex-shrink-0">
                        <span className={`absolute top-2.5 left-3 text-[9.5px] font-bold uppercase tracking-wider px-2 py-0.5 rounded text-white ${n.cat === "Event" ? "bg-red-warm" : "bg-green-DEFAULT"}`}>{n.cat}</span>
                      </div>
                      <div className="p-5">
                        <p className="text-[11px] text-gray-400 uppercase tracking-wide mb-2">{n.date}</p>
                        <h3 className="font-serif text-[17px] font-semibold text-ink leading-[1.35]">{n.title}</h3>
                      </div>
                    </div>
                  ))}
                </div>
      ...
      {/* ── RESEARCH CTA ── */}
      <section className="py-32 px-12 max-sm:py-0 max-sm:px-0" style={{ background: "#fafaf7" }}>
        {/* Mobile version */}
        <div className="sm:hidden">
          <div className="research-cta-mobile reveal">
            <div className="tag">{tr.research.pill as string}</div>
            <h3>{tr.research.heading as string}</h3>
            <p>{tr.research.desc as string}</p>
            <Link href="/research" className="btn-primary">
              {tr.research.cta as string} <ArrowRight size={14} />
            </Link>
          </div>
        </div>
        {/* Desktop version */}
        <div className="max-sm:hidden max-w-[1280px] mx-auto">
          <div className="bg-ink rounded-2xl px-14 py-14 grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-12 items-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              <span className="inline-flex items-center text-green-400 bg-green-400/10 border border-green-400/20 font-semibold px-3 py-1 rounded-full text-[11px] uppercase tracking-widest mb-5">{tr.research.pill as string}</span>
              <h2 className="font-serif text-[clamp(24px,3vw,40px)] font-semibold text-white leading-[1.2] mb-3">{tr.research.heading as string}</h2>
              <p className="text-[15px] text-white/55 max-w-[480px] leading-[1.8] font-light">{tr.research.desc as string}</p>
            </div>
            <Link href="/research" className="relative z-10 inline-flex items-center gap-2 bg-white text-ink text-sm font-bold px-8 py-4 rounded-xl hover:bg-green-light hover:text-green-deep transition-all whitespace-nowrap flex-shrink-0">{tr.research.cta as string} <ArrowRight size={16} /></Link>
          </div>
        </div>
      </section>

      {/* ── PARTNERS ── */}
      <section className="py-16 px-12 bg-white border-t border-b border-gray-200 max-sm:bg-transparent max-sm:border-transparent">
        <div className="max-w-[1280px] mx-auto">
          {/* Mobile version */}
          <div className="sm:hidden">
      ...
      {/* ── CONTACT STRIP ── */}
      <section className="py-20 px-12 bg-white max-sm:bg-transparent max-sm:py-8">
        {/* Mobile version */}
        <div className="sm:hidden">
            <div className="section-label-mobile reveal">Contact</div>
          <div className="contact-grid-mobile">
            <Link href="/contact" className="contact-card-mobile reveal">
              <div className="contact-card-icon-mobile">
                <Phone size={20} />
              </div>
              <div>
                <h4>{tr.contact.enquiryTitle as string}</h4>
                <p>{tr.contact.enquiryDesc as string}</p>
                <span className="link">{tr.contact.enquiryCta as string} →</span>
              </div>
            </Link>
            <Link href="/contact?type=complaint" className="contact-card-mobile reveal">
              <div className="contact-card-icon-mobile">
                <FileText size={20} />
              </div>
              <div>
                <h4>{tr.contact.complaintTitle as string}</h4>
                <p>{tr.contact.complaintDesc as string}</p>
                <span className="link">{tr.contact.complaintCta as string} →</span>
              </div>
            </Link>
            <Link href="/get-involved" className="contact-card-mobile reveal">
              <div className="contact-card-icon-mobile">
                <Users size={20} />
              </div>
              <div>
                <h4>{tr.contact.partnerTitle as string}</h4>
                <p>{tr.contact.partnerDesc as string}</p>
                <span className="link">{tr.contact.partnerCta as string} →</span>
              </div>
            </Link>
          </div>
        </div>
        ...
        {/* Desktop version */}
        <div className="max-sm:hidden max-w-7xl mx-auto grid grid-cols-3 max-lg:grid-cols-2 max-sm:grid-cols-1 gap-6">
          <Link href="/contact" className="p-8 border border-gray-200 rounded-xl transition-all duration-[0.35s] relative overflow-hidden hover:border-green-light hover:-translate-y-1 hover:shadow-[0_12px_36px_rgba(0,0,0,0.04)] reveal">
            ...
            <span className="text-[13px] font-semibold text-green-base flex items-center gap-1.5 transition-all duration-[0.25s]">{tr.contact.enquiryCta as string}<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M5 12h14" /><path d="m12 5 7 7-7 7" /></svg></span>
          </Link>
          <Link href="/contact?type=complaint" className="p-8 border border-gray-200 rounded-xl transition-all duration-[0.35s] relative overflow-hidden hover:border-green-light hover:-translate-y-1 hover:shadow-[0_12px_36px_rgba(0,0,0,0.04)] reveal delay-1">
            ...
            <span className="text-[13px] font-semibold text-green-base flex items-center gap-1.5 transition-all duration-[0.25s]">{tr.contact.complaintCta as string}<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M5 12h14" /><path d="m12 5 7 7-7 7" /></svg></span>
          </Link>
          <Link href="/get-involved" className="p-8 border border-gray-200 rounded-xl transition-all duration-[0.35s] relative overflow-hidden hover:border-green-light hover:-translate-y-1 hover:shadow-[0_12px_36px_rgba(0,0,0,0.04)] reveal delay-2">
            ...
            <span className="text-[13px] font-semibold text-green-base flex items-center gap-1.5 transition-all duration-[0.25s]">{tr.contact.partnerCta as string}<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M5 12h14" /><path d="m12 5 7 7-7 7" /></svg></span>
          </Link>
        </div>
      </section>
    </>
